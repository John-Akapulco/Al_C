...
# crash), reusing CONTCAR/WAVECAR/CHGCAR already sitting in ../P40/.
# The normal path is Al4C3_Pnma-III/run_chain.sh (one node, whole series).
#SBATCH --job-name=hp_Pnma-III_P30_resume
#SBATCH --nodes=1
#SBATCH --ntasks=48
...
cp ../P40/CONTCAR POSCAR
cp ../P40/WAVECAR WAVECAR
cp ../P40/CHGCAR CHGCAR
