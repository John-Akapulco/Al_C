...
# crash), reusing CONTCAR/WAVECAR/CHGCAR already sitting in ../P60/.
# The normal path is Al4C3_Pnma-III/run_chain.sh (one node, whole series).
#SBATCH --job-name=hp_Pnma-III_P70_resume
#SBATCH --nodes=1
#SBATCH --ntasks=48
...
cp ../P60/CONTCAR POSCAR
cp ../P60/WAVECAR WAVECAR
cp ../P60/CHGCAR CHGCAR
