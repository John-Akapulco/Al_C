...
# crash), reusing CONTCAR/WAVECAR/CHGCAR already sitting in ../P70/.
# The normal path is Al4C3_Pnma-III/run_chain.sh (one node, whole series).
#SBATCH --job-name=hp_Pnma-III_P80_resume
#SBATCH --nodes=1
#SBATCH --ntasks=48
...
cp ../P70/CONTCAR POSCAR
cp ../P70/WAVECAR WAVECAR
cp ../P70/CHGCAR CHGCAR
