...
# crash), reusing CONTCAR/WAVECAR/CHGCAR already sitting in ../P90/.
# The normal path is Al4C3_Pnma-III/run_chain.sh (one node, whole series).
#SBATCH --job-name=hp_Pnma-III_P100_resume
#SBATCH --nodes=1
#SBATCH --ntasks=48
...
cp ../P90/CONTCAR POSCAR
cp ../P90/WAVECAR WAVECAR
cp ../P90/CHGCAR CHGCAR
