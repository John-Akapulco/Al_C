...
# crash), reusing CONTCAR/WAVECAR/CHGCAR already sitting in ../P50/.
# The normal path is Al4C3_Pnma-III/run_chain.sh (one node, whole series).
#SBATCH --job-name=hp_Pnma-III_P40_resume
#SBATCH --nodes=1
#SBATCH --ntasks=48
...
cp ../P50/CONTCAR POSCAR
cp ../P50/WAVECAR WAVECAR
cp ../P50/CHGCAR CHGCAR
