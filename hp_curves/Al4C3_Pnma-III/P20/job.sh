...
# crash), reusing CONTCAR/WAVECAR/CHGCAR already sitting in ../P30/.
# The normal path is Al4C3_Pnma-III/run_chain.sh (one node, whole series).
#SBATCH --job-name=hp_Pnma-III_P20_resume
#SBATCH --nodes=1
#SBATCH --ntasks=48
...
cp ../P30/CONTCAR POSCAR
cp ../P30/WAVECAR WAVECAR
cp ../P30/CHGCAR CHGCAR
