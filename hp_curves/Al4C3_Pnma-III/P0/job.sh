...
# crash), reusing CONTCAR/WAVECAR/CHGCAR already sitting in ../P10/.
# The normal path is Al4C3_Pnma-III/run_chain.sh (one node, whole series).
#SBATCH --job-name=hp_Pnma-III_P0_resume
#SBATCH --nodes=1
#SBATCH --ntasks=48
...
cp ../P10/CONTCAR POSCAR
cp ../P10/WAVECAR WAVECAR
cp ../P10/CHGCAR CHGCAR
